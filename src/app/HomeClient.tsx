...
export default function HomeClient({ data }: { data: HomeData }) {
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] dark:bg-dark-bg font-['Noto_Sans_SC',sans-serif] transition-colors duration-300">
      ...
      <section className="relative h-screen flex items-center px-8 md:px-16 overflow-hidden bg-[#F9FAFB] dark:bg-dark-bg">
        ...
        <div className="relative z-10 max-w-5xl">
          ...
          <h1 className="text-[clamp(3.5rem,14vw,9rem)] font-bold leading-[0.88] tracking-[-0.03em] text-gray-900 dark:text-dark-text">{data.title}</h1>
          <p className="mt-10 max-w-lg text-sm leading-relaxed text-gray-500 dark:text-dark-muted">{data.bio}</p>
      ...
      <footer className="border-t border-gray-300 dark:border-dark-border px-8 md:px-16 py-16 relative overflow-hidden">
