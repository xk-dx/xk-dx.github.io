...
export default function BlogPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F9FAFB] via-[#FDF2F4] to-[#F0EDF5] font-['Noto_Sans_SC','Noto_Sans_JP',sans-serif] relative overflow-hidden">
      ...
      <header className="relative z-10 max-w-5xl mx-auto px-6 pt-16 pb-12">
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 tracking-tight">博客</h1>
        <p className="mt-3 text-sm text-gray-400">记录一些想法和日常</p>
      </header>
            ...
            return (
              <div key={post.slug}>
                <Link href={"/blog/" + post.slug}>
                  <div className="group relative bg-white/40 backdrop-blur-xl rounded-2xl p-7 border border-white/60 transition-all duration-500 hover:-translate-y-2 hover:shadow-xl hover:shadow-[#EFD3D7]/20">
                    ...
                    <h2 className="text-xl font-bold text-gray-900 group-hover:text-[#8E9AAF] transition-colors mb-3">{post.title}</h2>
                    <div className="flex items-center justify-between">
      ...
      <footer className="relative z-10 border-t border-[#CBC0D3]/20 px-6 py-12">
